...
const LoanApply = () => {
  ...
  const handleLoanFormSubmit = async () => {
    ...
    if (!documentType) {
      ...
      formData.append('fullName', loanFormData.fullName);
      formData.append('contactNumber', loanFormData.contactNumber);
      formData.append('email', loanFormData.email);
      formData.append('loanAmount', loanFormData.loanAmount);
      formData.append('purpose', loanFormData.purpose);
      formData.append('loanType', loanFormData.loanType);
      ...
      try {
        const response = await axios.post('http://localhost:8080/api/loan/apply', formData, {
          headers: {
